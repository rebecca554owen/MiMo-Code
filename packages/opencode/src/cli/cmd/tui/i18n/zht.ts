...
export const dict = {
  ...
  "tui.skill.data-analytics.description": "資料品質、指標診斷、KPI、報表、圖表與商業分析",
  "tui.skill.product-design.description": "產品設計探索、使用者體驗研究、設計實作與品質檢查",
  "tui.skill.sales.description": "銷售調研、客戶分析、會議準備、商機策略與預測審查",
