...
export const dict = {
  ...
  "tui.skill.data-analytics.description": "数据质量、指标诊断、KPI、报表、图表与业务分析",
  "tui.skill.product-design.description": "产品设计探索、用户体验研究、设计实现与质量检查",
  "tui.skill.sales.description": "销售调研、客户分析、会议准备、商机策略与预测审查",
